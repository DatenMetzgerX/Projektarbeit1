...
try {
	console.log(cliProgram.file);
	infer(cliProgram.file, context, program);

	const [sourceFile] = program.sourceFiles;
	...
	console.log(chalk.blue("Global scope"));
	program.globalScope.dump(process.stdout);
